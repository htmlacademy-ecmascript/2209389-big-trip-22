...
function sortPointsByTime(eventA, eventB) {
  const durationA = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(eventA.dateTo).diff(eventA.dateFrom);
  const durationB = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(eventB.dateTo).diff(eventB.dateFrom);
