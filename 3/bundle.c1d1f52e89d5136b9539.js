...
class TripPresenter {
  ...
  init() {
    ...
    (0,_render_js__WEBPACK_IMPORTED_MODULE_6__.render)(new _view_form_edit_view_js__WEBPACK_IMPORTED_MODULE_2__["default"](), this.editListComponent.getElement());
    for (let i = 0; i < POINTS_QUANTITY; i++) {
      (0,_render_js__WEBPACK_IMPORTED_MODULE_6__.render)(new _view_point_view_js__WEBPACK_IMPORTED_MODULE_3__["default"](), this.editListComponent.getElement());
    }
  }
}
