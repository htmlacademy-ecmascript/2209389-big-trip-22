...
const filter = {
  ...
  [_const__WEBPACK_IMPORTED_MODULE_0__.FilterType.FUTURE]: points => points.filter(point => dayjs__WEBPACK_IMPORTED_MODULE_1___default()(point.dateFrom).isAfter(dayjs__WEBPACK_IMPORTED_MODULE_1___default()())),
  [_const__WEBPACK_IMPORTED_MODULE_0__.FilterType.PRESENT]: points => points.filter(point => dayjs__WEBPACK_IMPORTED_MODULE_1___default()(point.dateFrom).isSameOrBefore(dayjs__WEBPACK_IMPORTED_MODULE_1___default()()) && dayjs__WEBPACK_IMPORTED_MODULE_1___default()(point.dateFrom).isSameOrAfter(dayjs__WEBPACK_IMPORTED_MODULE_1___default()())),
  [_const__WEBPACK_IMPORTED_MODULE_0__.FilterType.PAST]: points => points.filter(point => dayjs__WEBPACK_IMPORTED_MODULE_1___default()(point.dateTo).isBefore(dayjs__WEBPACK_IMPORTED_MODULE_1___default()()))
};
...
function generateFilter(points) {
  return Object.entries(_filter_js__WEBPACK_IMPORTED_MODULE_0__.filter).map(([filterType, filterPoints]) => ({
    type: filterType,
...
/* harmony import */ var _view_point_edit_view_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/point-edit-view.js */ "./src/view/point-edit-view.js");
...
/* harmony import */ var _view_empty_list_view_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../view/empty-list-view.js */ "./src/view/empty-list-view.js");
/* harmony import */ var _mock_filter_mock_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../mock/filter-mock.js */ "./src/mock/filter-mock.js");
...
class TripPresenter {
  ...
  #renderPoint(point, destinations, offers) {
    ...
    const pointComponent = new _view_point_view_js__WEBPACK_IMPORTED_MODULE_3__["default"]({
      point,
      destinations,
      offers,
      onRollupButtonClick: () => {
    ...
    const pointEditComponent = new _view_point_edit_view_js__WEBPACK_IMPORTED_MODULE_2__["default"]({
      point,
      destinations,
      offers,
      onEditFormSubmit: () => {
    ...
    function replacePointToForm() {
      (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_7__.replace)(pointEditComponent, pointComponent);
    }
    function replaceFormToPoint() {
      (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_7__.replace)(pointComponent, pointEditComponent);
    }
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_7__.render)(pointComponent, this.#editListComponent.element);
  }
  #renderTripEvents() {
    const points = this.#pointModel.points;
    const destinations = this.#pointModel.destinations;
    const offers = this.#pointModel.offers;
    const filters = (0,_mock_filter_mock_js__WEBPACK_IMPORTED_MODULE_9__.generateFilter)(points);
    if (points.length === 0) {
      (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_7__.render)(new _view_empty_list_view_js__WEBPACK_IMPORTED_MODULE_8__["default"](), this.#container, _render_js__WEBPACK_IMPORTED_MODULE_6__.RenderPosition.AFTERBEGIN);
      return;
    }
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_7__.render)(new _view_info_trip_view_js__WEBPACK_IMPORTED_MODULE_5__["default"](), this.#infoTripElement, _render_js__WEBPACK_IMPORTED_MODULE_6__.RenderPosition.AFTERBEGIN);
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_7__.render)(this.#sortComponent, this.#container);
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_7__.render)(this.#editListComponent, this.#container);
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_7__.render)(new _view_filter_veiw_js__WEBPACK_IMPORTED_MODULE_1__["default"]({
      filters
    }), this.#filterElement);
...
class EmptyListView extends _framework_view_abstract_view_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  get template() {
...
/******/ })()
;
//# sourceMappingURL=bundle.69b060030741c47ab214.js.map