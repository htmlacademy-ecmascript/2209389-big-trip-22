...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "emptyDestinations": () => (/* binding */ emptyDestinations),
/* harmony export */   "emptyOffers": () => (/* binding */ emptyOffers),
...
/* harmony export */ });
/* harmony import */ var _framework_observable_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../framework/observable.js */ "./src/framework/observable.js");
/* harmony import */ var _mock_points_mock_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../mock/points-mock.js */ "./src/mock/points-mock.js");
/* harmony import */ var _mock_offers_mock_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../mock/offers-mock.js */ "./src/mock/offers-mock.js");
/* harmony import */ var _mock_destinations_mock_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../mock/destinations-mock.js */ "./src/mock/destinations-mock.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (class extends _framework_observable_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  #points = null;
  #destinations = null;
  #offers = null;
  constructor() {
  ...
  init() {
    this.#points = _mock_points_mock_js__WEBPACK_IMPORTED_MODULE_1__.points;
    this.#destinations = _mock_destinations_mock_js__WEBPACK_IMPORTED_MODULE_3__.destinations;
    this.#offers = _mock_offers_mock_js__WEBPACK_IMPORTED_MODULE_2__.offers;
  }
  get points() {
    return this.#points;
  }
...
function generateFilter(pointsToFilter) {
  return Object.entries(_filter_js__WEBPACK_IMPORTED_MODULE_4__.filter).map(([filterType, filterPoints]) => ({
    type: filterType,
...
/* harmony import */ var _model_point_model_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../model/point-model.js */ "./src/model/point-model.js");
...
class FilterPresenter {
  ...
  init() {
    ...
    const filters = (0,_model_point_model_js__WEBPACK_IMPORTED_MODULE_3__.generateFilter)(points);
...
class NewPointPresenter {
  ...
  #handleFormSubmit = point => {
    this.#handleDataChange(_const_js__WEBPACK_IMPORTED_MODULE_2__.UserAction.ADD_POINT, _const_js__WEBPACK_IMPORTED_MODULE_2__.UpdateType.MINOR, {
...
/* harmony import */ var _view_no_points_view_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../view/no-points-view.js */ "./src/view/no-points-view.js");
/* harmony import */ var _point_presener_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./point-presener.js */ "./src/presenter/point-presener.js");
...
/* harmony import */ var _filter_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../filter.js */ "./src/filter.js");
/* harmony import */ var _new_point_presenter_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./new-point-presenter.js */ "./src/presenter/new-point-presenter.js");
...
class TripPresenter {
  ...
  #currentSortType = _const_js__WEBPACK_IMPORTED_MODULE_8__.SortType.DAY;
  #filterModel = null;
  #filterType = _const_js__WEBPACK_IMPORTED_MODULE_8__.FilterType.EVERYTHING;
  ...
  constructor({
    ...
    this.#filterModel = filterModel;
    this.#newPointPresenter = new _new_point_presenter_js__WEBPACK_IMPORTED_MODULE_10__["default"]({
  ...
  get points() {
    ...
    const filteredPoints = _filter_js__WEBPACK_IMPORTED_MODULE_9__.filter[this.#filterType](points);
    switch (this.#currentSortType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_8__.SortType.PRICE:
        return filteredPoints.sort(_utils_js__WEBPACK_IMPORTED_MODULE_7__.sortPointsByPrice);
      case _const_js__WEBPACK_IMPORTED_MODULE_8__.SortType.TIME:
        return filteredPoints.sort(_utils_js__WEBPACK_IMPORTED_MODULE_7__.sortPointsByTime);
      case _const_js__WEBPACK_IMPORTED_MODULE_8__.SortType.DAY:
        return filteredPoints.sort(_utils_js__WEBPACK_IMPORTED_MODULE_7__.sortPointsByDay);
    }
  ...
  createPoint() {
    this.#currentSortType = _const_js__WEBPACK_IMPORTED_MODULE_8__.SortType.DAY;
    this.#filterModel.setFilter(_const_js__WEBPACK_IMPORTED_MODULE_8__.UpdateType.MAJOR, _const_js__WEBPACK_IMPORTED_MODULE_8__.FilterType.EVERYTHING);
  ...
  #handleViewAction = (actionType, updateType, update) => {
    switch (actionType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_8__.UserAction.ADD_POINT:
        this.#pointModel.addPoint(updateType, update);
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_8__.UserAction.UPDATE_POINT:
        this.#pointModel.updatePoint(updateType, update);
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_8__.UserAction.DELETE_POINT:
  ...
  #renderSort() {
    ...
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_4__.render)(this.#sortComponent, this.#container);
  }
  #renderPoints(point, destinations, offers) {
    const pointPresenter = new _point_presener_js__WEBPACK_IMPORTED_MODULE_6__["default"]({
      pointListContainer: this.#pointsListComponent.element,
      onDataChange: this.#handleViewAction,
  ...
  #renderNoPoints() {
    this.#noPointsComponent = new _view_no_points_view_js__WEBPACK_IMPORTED_MODULE_5__["default"]({
      filterType: this.#filterType
    });
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_4__.render)(this.#noPointsComponent, this.#container, _render_js__WEBPACK_IMPORTED_MODULE_3__.RenderPosition.BEFOREEND);
  }
  #renderInfoTrip() {
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_4__.render)(this.#infoTripComponent, this.#infoTripElement, _render_js__WEBPACK_IMPORTED_MODULE_3__.RenderPosition.AFTERBEGIN);
  }
  #renderPointsList() {
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_4__.render)(this.#pointsListComponent, this.#container);
  }
  #renderTripEvents() {
    this.#renderInfoTrip();
    this.#renderSort();
    ...
    this.points.sort(_utils_js__WEBPACK_IMPORTED_MODULE_7__.sortPointsByDay);
  }
  #renderOnlyPoints() {
  ...
  #clearTrip({
    ...
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_4__.remove)(this.#sortComponent);
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_4__.remove)(this.#filterComponent);
    if (resetSortType) {
      this.#currentSortType = _const_js__WEBPACK_IMPORTED_MODULE_8__.SortType.DAY;
    }
    if (this.#noPointsComponent) {
      (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_4__.remove)(this.#noPointsComponent);
    }
  }
}
...
/* harmony import */ var _mock_const_mock_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../mock/const-mock.js */ "./src/mock/const-mock.js");
  ...
  return `<li class="trip-events__item">
    ...
    <header class="event__header">
      ...
      <div class="event__field-group  event__field-group--destination">
        ...
        <input class="event__input  event__input--destination" id="event-destination-${pointId}" type="text" name="event-destination" value="${he__WEBPACK_IMPORTED_MODULE_6___default().encode(name) || ''}" list="destination-list-${pointId}">
...
class PointEditView extends _framework_view_abstract_stateful_view_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  constructor({
    point = _mock_const_mock_js__WEBPACK_IMPORTED_MODULE_4__.emptyPoint,
    destinations = _mock_const_mock_js__WEBPACK_IMPORTED_MODULE_4__.emptyDestinations,
    offers = _mock_const_mock_js__WEBPACK_IMPORTED_MODULE_4__.emptyOffers,
    onEditFormSubmit,
    onRollupButtonClick,
    onDeleteClick
  }) {
...
/******/ })()
;
//# sourceMappingURL=bundle.e552369d09ec4294a7ec.js.map