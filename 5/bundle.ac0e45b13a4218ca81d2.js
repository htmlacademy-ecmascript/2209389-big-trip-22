...
class TripPresenter {
  ...
  #renderTripEvents() {
    ...
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_7__.render)(new _view_filter_veiw_js__WEBPACK_IMPORTED_MODULE_1__["default"](), this.#filterElement);
...
function humanizeDate(dueDate) {
  return dueDate ? dayjs__WEBPACK_IMPORTED_MODULE_0___default()(dueDate).format(_const_js__WEBPACK_IMPORTED_MODULE_1__.DATE_FORMAT) : '';
}
...
const createPointTemplate = (point, destinations, offers) => {
  ...
  <div class="event">
    <time class="event__date" datetime=${dateFrom}>${(0,_utils_js__WEBPACK_IMPORTED_MODULE_2__.humanizeDate)(dateFrom, _const_js__WEBPACK_IMPORTED_MODULE_0__.DATE_FORMAT)}</time>
    ...
    <div class="event__schedule">
      <p class="event__time">
        <time class="event__start-time" datetime=${dateFrom}>${(0,_utils_js__WEBPACK_IMPORTED_MODULE_2__.humanizeDate)(dateFrom, _const_js__WEBPACK_IMPORTED_MODULE_0__.DATE_FORMAT)}</time>
        &mdash;
        <time class="event__end-time" datetime=${dateTo}>${(0,_utils_js__WEBPACK_IMPORTED_MODULE_2__.humanizeDate)(dateTo, _const_js__WEBPACK_IMPORTED_MODULE_0__.DATE_FORMAT)}</time>
      </p>
      <p class="event__duration">1000000M</p>
    </div>
...
/******/ })()
;
//# sourceMappingURL=bundle.ac0e45b13a4218ca81d2.js.map