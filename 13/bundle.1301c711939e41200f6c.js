...
/* harmony export */   "TimeLimit": () => (/* binding */ TimeLimit),
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "newPointButton": () => (/* binding */ newPointButton)
/* harmony export */ });
/* harmony import */ var _model_points_model_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./model/points-model.js */ "./src/model/points-model.js");
...
/* harmony import */ var _points_api_service_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./points-api-service.js */ "./src/points-api-service.js");
...
const filterPresenter = new _presenter_filter_presenter_js__WEBPACK_IMPORTED_MODULE_3__["default"]({
...
class PointsModel extends _framework_observable_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  #points = [];
  #destinations = [];
  #offers = [];
  ...
  async init() {
    _main_js__WEBPACK_IMPORTED_MODULE_2__.newPointButton.disabled = true;
...
class PointsApiService extends _framework_api_service_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  get points() {
    return this._load({
      url: _const_js__WEBPACK_IMPORTED_MODULE_1__.BaseUrl.POINTS
    }).then(_framework_api_service_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseResponse);
  }
  get destinations() {
    return this._load({
      url: _const_js__WEBPACK_IMPORTED_MODULE_1__.BaseUrl.DESTINATIONS
    }).then(_framework_api_service_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseResponse);
  }
  get offers() {
    return this._load({
      url: _const_js__WEBPACK_IMPORTED_MODULE_1__.BaseUrl.OFFERS
    }).then(_framework_api_service_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseResponse);
  }
  async addPoint(point) {
    const response = await this._load({
      url: `${_const_js__WEBPACK_IMPORTED_MODULE_1__.BaseUrl.POINTS}`,
      method: _const_js__WEBPACK_IMPORTED_MODULE_1__.ApiMethod.POST,
  ...
  async deletePoint(point) {
    const response = await this._load({
      url: `${_const_js__WEBPACK_IMPORTED_MODULE_1__.BaseUrl.POINTS}/${point.id}`,
      method: _const_js__WEBPACK_IMPORTED_MODULE_1__.ApiMethod.DELETE
    });
    return response;
  }
  async updatePoint(point) {
    ...
    const response = await this._load({
      url: `${_const_js__WEBPACK_IMPORTED_MODULE_1__.BaseUrl.POINTS}/${point.id}`,
      //адрес ресурса с КОНКРЕТНОЙ задачей для точного обновления
      method: _const_js__WEBPACK_IMPORTED_MODULE_1__.ApiMethod.PUT,
      // указывается метод для обновления задачи - PUT
      body: JSON.stringify(this.#adaptToServer(point)),
      // 1) переводим объект в вид, с которым умеет работать сервер 2) преобразовываем в JSON формат и передаем на сервер
      headers: new Headers({
        'Content-Type': 'application/json'
      }) // в заголовке сообщаем что сожержимое будет в формате JSON
    });
...
class FilterPresenter {
  ...
  init() {
    ...
    const filters = (0,_filter_js__WEBPACK_IMPORTED_MODULE_3__.generateFilter)(points);
  ...
  #handleFilterTypeChange = filterType => {
    ...
    this.#filterModel.setFilter(_const_js__WEBPACK_IMPORTED_MODULE_2__.UpdateType.MAJOR, filterType);
  };
}
...
class NewPointPresenter {
  ...
  constructor({
    ...
    this.#points = _const_js__WEBPACK_IMPORTED_MODULE_2__.emptyPoint;
  }
  init() {
    ...
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(this.#pointEditComponent, this.#pointListContainer, _framework_render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.AFTERBEGIN);
...
class PointPresenter {
  ...
  init(point, destinations, offers) {
    ...
    if (this.#mode === Mode.EDITING) {
      (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_0__.replace)(this.#pointComponent, prevPointEditComponent);
  ...
  #handleFavoriteClick = () => {
    this.#handleDataChange(_const_js__WEBPACK_IMPORTED_MODULE_3__.UserAction.UPDATE_POINT, _const_js__WEBPACK_IMPORTED_MODULE_3__.UpdateType.MINOR, {
      ...this.#point,
...
/* harmony import */ var _view_info_trip_view_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/info-trip-view.js */ "./src/view/info-trip-view.js");
/* harmony import */ var _view_no_points_view_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../view/no-points-view.js */ "./src/view/no-points-view.js");
/* harmony import */ var _view_loading_view_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../view/loading-view.js */ "./src/view/loading-view.js");
/* harmony import */ var _point_presener_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./point-presener.js */ "./src/presenter/point-presener.js");
/* harmony import */ var _new_point_presenter_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./new-point-presenter.js */ "./src/presenter/new-point-presenter.js");
...
/* harmony import */ var _filter_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../filter.js */ "./src/filter.js");
/* harmony import */ var _framework_ui_blocker_ui_blocker_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../framework/ui-blocker/ui-blocker.js */ "./src/framework/ui-blocker/ui-blocker.js");
...
class TripPresenter {
  ...
  #infoTripComponent = new _view_info_trip_view_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
  #loadingComponent = new _view_loading_view_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
  #filterComponent = null;
  #container = null;
  #pointModel = null;
  #infoTripElement = null;
  #pointPresenters = new Map();
  #currentSortType = _const_js__WEBPACK_IMPORTED_MODULE_10__.SortType.DAY;
  #filterModel = null;
  ...
  constructor({
    ...
    this.#filterModel = filterModel;
    this.#newPointPresenter = new _new_point_presenter_js__WEBPACK_IMPORTED_MODULE_6__["default"]({
  ...
  get points() {
    ...
    const filteredPoints = _filter_js__WEBPACK_IMPORTED_MODULE_11__.filter[this.#filterType](points);
    switch (this.#currentSortType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_10__.SortType.PRICE:
        return filteredPoints.sort(_utils_js__WEBPACK_IMPORTED_MODULE_9__.sortPointsByPrice);
      case _const_js__WEBPACK_IMPORTED_MODULE_10__.SortType.TIME:
        return filteredPoints.sort(_utils_js__WEBPACK_IMPORTED_MODULE_9__.sortPointsByTime);
      case _const_js__WEBPACK_IMPORTED_MODULE_10__.SortType.DAY:
        return filteredPoints.sort(_utils_js__WEBPACK_IMPORTED_MODULE_9__.sortPointsByDay);
    }
  ...
  createPoint() {
    this.#currentSortType = _const_js__WEBPACK_IMPORTED_MODULE_10__.SortType.DAY;
    this.#filterModel.setFilter(_const_js__WEBPACK_IMPORTED_MODULE_10__.UpdateType.MAJOR, _const_js__WEBPACK_IMPORTED_MODULE_10__.FilterType.EVERYTHING);
  ...
  #handleViewAction = async (actionType, updateType, update) => {
    ...
    switch (actionType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_10__.UserAction.ADD_POINT:
        ...
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_10__.UserAction.UPDATE_POINT:
        ...
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_10__.UserAction.DELETE_POINT:
  ...
  #renderSort() {
    this.#sortComponent = new _view_sort_view_js__WEBPACK_IMPORTED_MODULE_1__["default"]({
      currentSortType: this.#currentSortType,
      onSortTypeChange: this.#handleSortTypeChange
    });
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_8__.render)(this.#sortComponent, this.#container);
  }
  #renderPoints(point) {
    const pointPresenter = new _point_presener_js__WEBPACK_IMPORTED_MODULE_5__["default"]({
      pointListContainer: this.#pointsListComponent.element,
      onDataChange: this.#handleViewAction,
  ...
  #renderNoPoints() {
    this.#noPointsComponent = new _view_no_points_view_js__WEBPACK_IMPORTED_MODULE_3__["default"]({
      filterType: this.#filterType
    });
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_8__.render)(this.#noPointsComponent, this.#container, _render_js__WEBPACK_IMPORTED_MODULE_7__.RenderPosition.AFTEREND);
  }
  #renderInfoTrip() {
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_8__.render)(this.#infoTripComponent, this.#infoTripElement, _render_js__WEBPACK_IMPORTED_MODULE_7__.RenderPosition.AFTERBEGIN);
  }
  #renderPointsList() {
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_8__.render)(this.#pointsListComponent, this.#container);
  }
  #renderLoading() {
  ...
  #clearTrip({
    ...
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_8__.remove)(this.#sortComponent);
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_8__.remove)(this.#filterComponent);
    (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_8__.remove)(this.#loadingComponent);
    if (resetSortType) {
      this.#currentSortType = _const_js__WEBPACK_IMPORTED_MODULE_10__.SortType.DAY;
    }
    if (this.#noPointsComponent) {
      (0,_framework_render_js__WEBPACK_IMPORTED_MODULE_8__.remove)(this.#noPointsComponent);
    }
  }
}
...
function sortPointsByTime(pointA, pointB) {
  const durationA = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(pointA.dateTo).diff(pointA.dateFrom);
  const durationB = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(pointB.dateTo).diff(pointB.dateFrom);
  return durationB - durationA;
}
function sortPointsByDay(pointA, pointB) {
  return dayjs__WEBPACK_IMPORTED_MODULE_0___default()(pointA.dateFrom) - dayjs__WEBPACK_IMPORTED_MODULE_0___default()(pointB.dateFrom);
}
...
const NoPointsTextType = {
  ...
  [_const_js__WEBPACK_IMPORTED_MODULE_1__.FilterType.PAST]: 'There are no past events now',
  [_const_js__WEBPACK_IMPORTED_MODULE_1__.FilterType.PRESENT]: 'There are no present events now',
  [_const_js__WEBPACK_IMPORTED_MODULE_1__.FilterType.FUTURE]: 'There are no future events now'
};
  ...
  return `<li class="trip-events__item">
    ...
    <header class="event__header">
      ...
      <div class="event__field-group  event__field-group--destination">
        ...
        <input class="event__input  event__input--destination" id="event-destination-${pointId}" type="text" name="event-destination" value="${he__WEBPACK_IMPORTED_MODULE_5___default().encode(name || '')}" list="destination-list-${pointId}" required>
...
class PointEditView extends _framework_view_abstract_stateful_view_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  #destinations = null;
  #offers = null;
...
const createPointTemplate = (point, destinations, offers) => {
  ...
  <div class="event">
    ...
    <h3 class="event__title">${type} ${he__WEBPACK_IMPORTED_MODULE_3___default().encode(pointDestination.name)}</h3>
...
function createSortTemplate(currentSortType) {
  ...
  <div class="trip-sort__item  trip-sort__item--day" >
    <input id="sort-day" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-day" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__.SortType.DAY}" ${currentSortType === _const_js__WEBPACK_IMPORTED_MODULE_1__.SortType.DAY ? 'checked' : ''}>
  ...
  <div class="trip-sort__item  trip-sort__item--time">
    <input id="sort-time" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-time" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__.SortType.TIME}" ${currentSortType === _const_js__WEBPACK_IMPORTED_MODULE_1__.SortType.TIME ? 'checked' : ''}>
    <label class="trip-sort__btn" for="sort-time">Time</label>
  </div>

  <div class="trip-sort__item  trip-sort__item--price">
    <input id="sort-price" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-price" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__.SortType.PRICE}" ${currentSortType === _const_js__WEBPACK_IMPORTED_MODULE_1__.SortType.PRICE ? 'checked' : ''}>
...
/******/ })()
;
//# sourceMappingURL=bundle.1301c711939e41200f6c.js.map